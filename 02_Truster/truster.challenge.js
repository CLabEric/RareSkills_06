...
describe("[Challenge] Truster", function () {
  ...
  before(async function () {
    ...
    attacker = await (
      await ethers.getContractFactory("LenderPoolAttack", deployer)
...
// So using <contractAddress>.call{value: x}(data) also maintains context like delegate call??
