...
describe(NAME, function () {
    async function setup() {
        ...
        const AttackerFactoryFactory = await ethers.getContractFactory("DeleteUserAttacker");
        const attackerContract = await AttackerFactoryFactory.deploy(victimContract.address);
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
            ...
            // // await victimContract.connect(attackerWallet).withdraw(1);
            // // await victimContract.connect(attackerWallet).withdraw(0);
        });
